...
function Home() {
    ...
    const loginTwitter = () => {
        window.open("http://localhost:5000/twitter", '_blank', 'location=yes,height=570,width=520,scrollbars=yes,status=yes')
    }
    const loginGithub = () => {
        window.open("http://localhost:5000/github", '_blank', 'location=yes,height=570,width=520,scrollbars=yes,status=yes')
    }

    const loginDiscord = () => {
        window.open("http://localhost:5000/discord", '_blank', 'location=yes,height=570,width=520,scrollbars=yes,status=yes')
    }
